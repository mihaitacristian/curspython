...
def modify_entry():
    backend.update(selected_tuple[0],name_text.get(),CNP_text.get(),salariu.get())
...
b3=Button(window,text="modify entry", width=12,command=modify_entry)
b3.grid(row=2, column=3)

# b4=Button(window,text="modify salariu", width=12,command=modify_salariu)
